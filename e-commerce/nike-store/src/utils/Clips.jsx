    ...
    return (
        <>
            <div className="group relative h-28 w-32 cursor-pointer overflow-hidden rounded-xl transition-all duration-300 lg:h-24 lg:w-28 md:h-20 md:w-24 sm:h-14 sm:w-16">
                ...
                />
                <div className="blur-effect-theme absolute left-11 right-0 top-11 z-[100] flex h-8 w-8 items-center justify-center rounded-full bg-white/75 opacity-100 lg:left-9 lg:top-8 md:h-5 md:w-5 sm:left-5 sm:top-4">
                ...
                <video
                    ...
                    muted={true}
                    playsInline={true}
                    className="absolute left-0 right-0 top-0 z-0 flex h-full w-full rounded-xl object-cover opacity-0 group-hover:z-50 group-hover:opacity-100"
                >
